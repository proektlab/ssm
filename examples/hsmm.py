...
from ssm_customized.util import rle, find_permutation
...
true_hsmm = ssm_customized.HSMM(K, D, observations="gaussian")
...
hsmm = ssm_customized.HSMM(K, D, observations="gaussian")
